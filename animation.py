...
def massinit(weight, sp):
    ...
    point = [0] * 8
    peak[0] = sp;
    peak[1] = [sp[0] + 0.13, sp[1], sp[2]]
    peak[2] = [sp[0] + 0.05, sp[1] + 0.04, sp[2]]
    peak[3] = [sp[0] + 0.07, sp[1] + 0.08, sp[2] + 0.12]
    peak[4] = [sp[0], sp[1] + 0.023, sp[2]]
    peak[5] = [sp[0], sp[1] + 0.01, sp[2] + 0.1]
    peak[6] = [sp[0], sp[1], sp[2] + 0.1]
    peak[7] = [sp[0] + 0.03, sp[1], sp[2] + 0.12]
    for i in range(8):
...
def main():
    csv_file = open('GA_Robot_test1.csv', 'r')
    a = []
    b = []
    c = []
    d = []
    ...
    for dataA, dataB, dataC, dataD, dataE in csv.reader(csv_file, delimiter=','):
        ...
        sk.append(int(dataE))
    csv_file2 = open('GA_Robot_test1_position.csv', 'r')
    point_position = [];
    ...
    plane = createPlane()
    peak = massinitv3(1, [0.0, 0.0, 0.0],point_position)
