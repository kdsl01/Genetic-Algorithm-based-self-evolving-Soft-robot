...
void crossoverv3(sets tops[], sets children[]) {
    ...
    for (int i = 0; i < 20; i++) {
        ...
        if (cr == 0 || cr == 2 || cr == 4 || cr == 6 || cr == 8 || cr == 10 || cr == 12 || cr == 14 || cr == 16 ||
            ...
            children[i].sn = lspn;
            children[i].pn = cpn;
            children[i].p0.resize(cpn - 1);
            children[i].p1.resize(cpn - 1);
            children[i].p2.resize(cpn - 1);
...
int main() {
    ...
    ctm[1] = 0;
    ctm[2] = 0;
    ofstream fout2("GA_Robot_test1v4_5.csv", ios::out);
...
//        cout<<ctmf[0]<<","<<ctmf[1]<<","<<ctmf[2]<<"\n";
    ...
    for (int i = 0; i < 10000; i++) {
        ...
        if (varx[0].speed > bestspeed) {
            ...
            ofstream fout1("GA_Robot_Variablev4_5.csv", ios::out);
            ofstream fout3("GA_Robot_positionv4_5.csv", ios::out);
